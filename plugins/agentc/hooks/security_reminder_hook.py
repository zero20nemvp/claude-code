...
Only use exec() if you absolutely need shell features and the input is guaranteed to be safe.""",
    ...
    },
    {
        ...
        "substrings": [".html_safe", "raw("],
        "reminder": "Security Warning: html_safe and raw() bypass Rails XSS protection. Only use with trusted content or after proper sanitization.",
    },
]
